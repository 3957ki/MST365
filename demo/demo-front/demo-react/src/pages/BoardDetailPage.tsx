...
import { getBoardById, BoardDetail, deleteBoard } from "../api-temp/board"; // Corrected API path
import {
  createComment,
  getComments,
  updateComment,
  deleteComment,
  CommentData,
} from "../api-temp/comment"; // Corrected API path
...
const BoardDetailPage: React.FC = () => {
  // Signature changed
  const { board_id } = useParams<{ board_id: string }>(); // Use useParams
    ...
    <div className="container mx-auto p-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="space-y-4 mb-6">
          {/* Add type annotation for comment parameter */}
